...
6. Can you get the percentile 93% of every column in bumpus.num?
...
7. Try to get the spearman correlation matrix.
...
8. What value does this table hold?
...
9. Correct the error!
10. Check column sums to see if the results is as expected.
